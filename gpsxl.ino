...
String message = "{\"eventName\":\"GPS\",\"status\":\"none\",\"lat\":" + String(gps.location.lat(), 6) + ",\"lot\":" + String(gps.location.lng(),6) + ",\"mac\":\"" + DEVICE_SERIAL + "\"}";
//String message = "{\"eventName\":\"tempChanged\",\"status\":\"none\",\"temp\":" + String(t) + ",\"humid\":" + String(h) + ",\"mac\":\"" + DEVICE_SERIAL + "\"}";
